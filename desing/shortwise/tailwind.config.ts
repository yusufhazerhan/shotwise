...
/**
 * Shotwise — drop-in Tailwind config
 * Mirrors the tokens defined in `brand.css` so a Next.js port can swap
 * CSS variables for `className` utilities without color drift.
 */
export default {
  darkMode: ["class"],
